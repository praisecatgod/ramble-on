 ...
 * @author yv
 */
public class LeaderHandler implements ActionListener {
    
    private RambleOn ro;
    public LeaderHandler(RambleOn initRo)
    {
        ro = initRo;
    }
    ...
    public void actionPerformed(ActionEvent e) 
    {
      ...
      {
          ( (RambleOnDataModel) ro.getDataModel() ).goToRegionPickerMode(ro, LEADER_TYPE);
      }
